           ...
           <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
             {[
               ...
               <div key={index} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                 ...
                 <div className="p-4">
                   <h4 className="font-serif font-semibold text-lg mb-1 text-gray-900">{product.name}</h4>
                   <p className="text-gray-600 text-sm mb-2">{product.farmer}</p>
                   <div className="flex items-center justify-between">
                     <span className="font-semibold text-[#006C36] text-lg">{product.price}</span>
